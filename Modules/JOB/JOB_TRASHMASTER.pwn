#define     TRASH_BAG_VALUE     (70)    	// value of a collected trash bag (default: 125)
...
IsATrashCar(carid)
{
	for (new i; i < sizeof(TrashVeh); i ++) {
		if (carid == TrashVeh[i]) return 1;
	}
	return 0;
}
...
CreateTrashMaster()
{
	...
	TrashVeh[0] = AddStaticVehicleEx(408, 2429.2720, -2078.1804, 14.0648, 0.8974, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[1] = AddStaticVehicleEx(408, 2448.4060, -2077.8284, 14.0648, 0.8974, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[2] = AddStaticVehicleEx(408, 2458.3445, -2078.3604, 14.0648, 358.6954, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[3] = AddStaticVehicleEx(408, 2437.5322, -2078.2776, 14.0648, 0.8974, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[4] = AddStaticVehicleEx(408, 2468.4639, -2077.9846, 14.0648, 358.6954, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[5] = AddStaticVehicleEx(408, 2468.4639, -2077.9846, 14.0648, 358.6954, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[6] = AddStaticVehicleEx(408, 2478.7544, -2078.1116, 14.0648, 358.6954, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[7] = AddStaticVehicleEx(408, 2488.9695, -2077.9639, 14.0648, 358.6954, 0, 0, VEHICLE_RESPAWN);
	TrashVeh[8] = AddStaticVehicleEx(408, 2498.9329, -2078.0945, 14.0648, 358.6954, 0, 0, VEHICLE_RESPAWN);
}
...
CMD:pickup(playerid, params[])
{
	...
	new vehicleid = GetPVarInt(playerid, "LastVehID");
	if (pData[playerid][pSideJob] != 4) return Error(playerid,"Kamu harus menjadi Trashmaster untuk mengambil sampah.");
	...
	SendClientMessage(playerid, 0x2ECC71FF, "TRASHMASTER JOB: {FFFFFF}You can press {F39C12}N {FFFFFF}to remove the trash bag.");
	return 1;
}