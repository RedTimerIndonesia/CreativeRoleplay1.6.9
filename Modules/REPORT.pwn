...
CMD:respond(playerid, params[])
{
    ...
    SendStaffMessage(COLOR_RED, "AdmCmd: %s "YELLOW_E"has accepted %s(%d) report.", pData[playerid][pAdminname], pData[ReportData[reportid][rPlayer]][pName], ReportData[reportid][rPlayer]);
...
CMD:dr(playerid, params[])
{
    ...
    SendStaffMessage(COLOR_RED, "AdmCmd: %s "YELLOW_E"has denied %s(%d) report.", pData[playerid][pAdminname], pData[ReportData[reportid][rPlayer]][pName], ReportData[reportid][rPlayer]);
