            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
              <table class="table table-def table-hover table-striped table-condensed table-bordered" style="height: 100%;">
                ...
                <tbody>
                  ...
                  ?>
                  <tr><td><?= $v["id"]; ?></td><td><?= $v["sender"]; ?></td><td><?php if ($v["vip"] == 1) echo "VIP Reguler"; elseif ($v["vip"] == 2) echo "VIP Premium"; elseif ($v["vip"] == 3) echo "VIP Platinum(Lifetime)"; elseif ($v["gold"] != 0) echo "Gold (".$v["gold"].")"; ?></td><td><?php if ($v["payment"] == 1) echo "Gopay (087782324804) A/n. Muhammad Misbah Guntur"; elseif ($v["payment"] == 2) echo "DANA (087782324804) A/n. Muhammad Misbah Guntur"; elseif ($v["payment"] == 3) echo "Ovo (087782324804) A/n. Muhammad Misbah Guntur"; elseif ($v["payment"] == 4) echo "Bank BNI (PM Discord/WA) A/n. Muhammad Misbah Guntur"; ?></td><td>Rp <?= number_format($v["nominal"]); ?></td><td><?= $v["bukti"]; ?></td><td><?= $v["note"]; ?></td><td><button class="btn btn-success" type="button" id="btn-accept" data-id="<?= $v['id']; ?>">Accept</button><button class="btn btn-danger" id="btn-denied" data-id="<?= $v["id"]; ?>">Denied</button></td></tr>
                  <?php endwhile;
                  else : ?>
