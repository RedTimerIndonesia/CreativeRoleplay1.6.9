...
#include "./map/lacostra_ext.pwn"
//#include "./map/cityhallnew.pwn"

#include "./map/rumah_hafis.pwn"

#include "./map/cityhallethernal.pwn"

#include "./map/map_depanasgh.pwn"

#include "./map/mapbank.pwn"
...
public OnPlayerConnect(playerid)
{
	...
	//RemoveObjectCH(playerid);
	RemoveObjectRumahHafis(playerid);
	
	RbuildingCityHallNew(playerid);

	RbuildingDepanASGH(playerid);

	RbuildTextSanews(playerid);
