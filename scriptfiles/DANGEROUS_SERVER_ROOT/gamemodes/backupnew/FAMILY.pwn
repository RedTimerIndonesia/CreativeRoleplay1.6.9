...
Family_Refresh(id)
{
	if(id != -1)
	{
        ...
        if(fData[id][fIntposX] != 0.0 && fData[id][fIntposY] != 0.0 && fData[id][fIntposZ] != 0.0)
        {
            ...
            fData[id][fLabelint] = CreateDynamic3DTextLabel(mstr, COLOR_YELLOW, fData[id][fIntposX], fData[id][fIntposY], fData[id][fIntposZ]+0.7, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, fData[id][fInt]);
            fData[id][fPickint] = CreateDynamicPickup(19130, 23, fData[id][fIntposX], fData[id][fIntposY], fData[id][fIntposZ], 0, fData[id][fInt], -1, 7);
        }
		if(fData[id][fSafeposX] != 0.0 && fData[id][fSafeposY] != 0.0 && fData[id][fSafeposZ] != 0.0)
		{
            ...
            fData[id][fPicksafe] = CreateDynamicPickup(1239, 23, fData[id][fSafeposX], fData[id][fSafeposY], fData[id][fSafeposZ], 0, -1, -1, 7);
		}
	}
}
 	...
 	if(rows)
  	{
		...
		for(new i; i < rows; i++)
		{
		    ...
		    cache_get_value_float(i, "extposx", fData[fid][fExtposX]);
		    cache_get_value_float(i, "extposy", fData[fid][fExtposY]);
		    cache_get_value_float(i, "extposz", fData[fid][fExtposZ]);
		    cache_get_value_float(i, "extposa", fData[fid][fExtposA]);
		    cache_get_value_float(i, "intposx", fData[fid][fIntposX]);
		    cache_get_value_float(i, "intposy", fData[fid][fIntposY]);
		    cache_get_value_float(i, "intposz", fData[fid][fIntposZ]);
		    cache_get_value_float(i, "intposa", fData[fid][fIntposA]);
		    cache_get_value_int(i, "fint", fData[fid][fInt]);
			cache_get_value_float(i, "safex", fData[fid][fSafeposX]);
			cache_get_value_float(i, "safey", fData[fid][fSafeposY]);
			cache_get_value_float(i, "safez", fData[fid][fSafeposZ]);
			cache_get_value_int(i, "money", fData[fid][fMoney]);
			cache_get_value_int(i, "drug", fData[fid][fDrug]);
			
			cache_get_value_int(i, "Weapon1", fData[fid][fGun][0]);
			cache_get_value_int(i, "Weapon2", fData[fid][fGun][1]);
			cache_get_value_int(i, "Weapon3", fData[fid][fGun][2]);
			cache_get_value_int(i, "Weapon4", fData[fid][fGun][3]);
			cache_get_value_int(i, "Weapon5", fData[fid][fGun][4]);
			cache_get_value_int(i, "Weapon6", fData[fid][fGun][5]);
			cache_get_value_int(i, "Weapon7", fData[fid][fGun][6]);
			cache_get_value_int(i, "Weapon8", fData[fid][fGun][7]);
			cache_get_value_int(i, "Weapon9", fData[fid][fGun][8]);
			cache_get_value_int(i, "Weapon10", fData[fid][fGun][9]);
			
			cache_get_value_int(i, "Ammo1", fData[fid][fAmmo][0]);
			cache_get_value_int(i, "Ammo2", fData[fid][fAmmo][1]);
			cache_get_value_int(i, "Ammo3", fData[fid][fAmmo][2]);
			cache_get_value_int(i, "Ammo4", fData[fid][fAmmo][3]);
			cache_get_value_int(i, "Ammo5", fData[fid][fAmmo][4]);
			cache_get_value_int(i, "Ammo6", fData[fid][fAmmo][5]);
			cache_get_value_int(i, "Ammo7", fData[fid][fAmmo][6]);
			cache_get_value_int(i, "Ammo8", fData[fid][fAmmo][7]);
			cache_get_value_int(i, "Ammo9", fData[fid][fAmmo][8]);
			cache_get_value_int(i, "Ammo10", fData[fid][fAmmo][9]);
			/*for (new j = 0; j < 10; j ++)
			{
