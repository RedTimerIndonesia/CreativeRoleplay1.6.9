CMD:acmds(playerid)
{
    ...
    /setam /gotoco /gotohouse /gotobisnis /gotodoor /gotolocker /gotogs");
...
CMD:setpassword(playerid, params[])
{
	...
	mysql_tquery(g_SQL, query, "ChangePlayerPassword", "iss", playerid, cname, tmp);
	return 1;
}
