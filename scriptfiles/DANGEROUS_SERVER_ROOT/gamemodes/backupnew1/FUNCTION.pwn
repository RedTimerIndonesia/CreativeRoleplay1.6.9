...
function AssignPlayerData(playerid)
{
	...
	cache_get_value_int(0, "reg_id", pData[playerid][pID]);
	...
	cache_get_value_int(0, "food", pData[playerid][pFood]);
	cache_get_value_int(0, "seed", pData[playerid][pSeed]);
	cache_get_value_int(0, "potato", pData[playerid][pPotato]);
	cache_get_value_int(0, "wheat", pData[playerid][pWheat]);
	cache_get_value_int(0, "orange", pData[playerid][pOrange]);
	cache_get_value_int(0, "price1", pData[playerid][pPrice1]);
	cache_get_value_int(0, "price2", pData[playerid][pPrice2]);
	cache_get_value_int(0, "price3", pData[playerid][pPrice3]);
	cache_get_value_int(0, "price4", pData[playerid][pPrice4]);
	cache_get_value_int(0, "marijuana", pData[playerid][pMarijuana]);
	cache_get_value_int(0, "plant", pData[playerid][pPlant]);
	cache_get_value_int(0, "plant_time", pData[playerid][pPlantTime]);
	...
	cache_get_value_int(0, "hbemode", pData[playerid][pHBEMode]);
