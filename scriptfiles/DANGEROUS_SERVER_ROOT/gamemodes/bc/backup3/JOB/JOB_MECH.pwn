...
CMD:service(playerid, params[])
{
	if(pData[playerid][pJob] == 2 || pData[playerid][pJob2] == 2)
	{
		...
		if(GetNearestVehicleToPlayer(playerid, 3.5, false) == pData[playerid][pMechVeh])
		{
			...
			format(Dstring, sizeof(Dstring), "%sSpray Car\t30\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sPaint Job Car\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sWheels Car\t60\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sSpoiler Car\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sHood Car\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sVents Car\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sLights Car\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sExhausts\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sFront bumpers\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sRear Bumpers\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sRoofs Car\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sSide skirts\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sBullbars\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sStereo\t60\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sHydraulics\t60\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sNitro 1\t50\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sNitro 2\t80\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sNitro 3\t100\n", Dstring);
			format(Dstring, sizeof(Dstring), "%sNeon\t100\n", Dstring);
