...
CMD:gshop(playerid, params[])
{
	...
	Instant Change Name\t30 Gold\n");
	format(Dstring, sizeof(Dstring), "%sClear Warning\t20 Gold\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sVIP Level 1(7 Days)\t10 Gold\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sVIP Level 2(7 Days)\t20 Gold\n", Dstring);
	format(Dstring, sizeof(Dstring), "%sVIP Level 3(7 Days)\t30 Gold\n", Dstring);
...
CMD:settings(playerid)
{
	...
	new str[1024], hbemode[64], togpm[64], toglog[64];
