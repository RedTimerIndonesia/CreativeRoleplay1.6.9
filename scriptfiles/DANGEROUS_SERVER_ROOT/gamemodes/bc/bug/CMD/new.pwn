CMD:acmds(playerid)
{
	...
	/reports /ar /dr /vmodels /vehname /apv /aveh /gotoveh /getveh /respawnveh");

	strcat(line3, "\n\n"WHITE_E"Senior Admin Commands:"LB2_E"\n\
 	/clearreports /afix /setskin /akill /ann /settime /setweather \n\
    /gotoco /gotohouse /gotobisnis /gotodoor /gotolocker /gotogs");

	strcat(line3, "\n\n"WHITE_E"Lead Admin Commands:"LB2_E"\n\
	/oban /banip /unbanip /reloadweap /resetweap /sethbe\n\
 	/ojail /owarn /createdoor /editdoor");
	...
	/sethelperlevel /setaname /setmoney /givemoney /setbankmoney /givebankmoney\n\
	/setmaterial /setcomponent /createpv /destroypv /explode\n");
	
	strcat(line3, "\n\n"WHITE_E"Developer Commands:"LB2_E"\n\
	/setadminlevel /setgold /givegold /setstock /setprice\n\
	/createhouse /edithouse /createbisnis /editbisnis\n\");
...
CMD:warn(playerid, params[])
{
	...
	pData[otherid][pWarn]++;
	SendClientMessageToAllEx(COLOR_LRED, "Admin %s telah memberikan warning kepada player %s. [Reason: %s] [Total Warning: %d/20]", pData[playerid][pAdminname], pData[otherid][pName], reason, pData[otherid][pWarn]);
    return 1;
}
