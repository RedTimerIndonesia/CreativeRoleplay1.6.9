...
Doors_Save(id)
{
	...
	dData[id][dName], dData[id][dPass], dData[id][dIcon], dData[id][dLocked], dData[id][dAdmin], dData[id][dVip], dData[id][dFaction], dData[id][dFamily], dData[id][dCustom], dData[id][dExtvw], dData[id][dExtint], dData[id][dExtposX], dData[id][dExtposY], dData[id][dExtposZ], dData[id][dExtposA], dData[id][dIntvw], dData[id][dIntint],
 	...
 	if(rows)
  	{
		...
		for(new i; i < rows; i++)
		{
		    ...
		    cache_get_value_float(i, "extposx", dData[did][dExtposX]);
			cache_get_value_float(i, "extposy", dData[did][dExtposY]);
			cache_get_value_float(i, "extposz", dData[did][dExtposZ]);
			cache_get_value_float(i, "extposa", dData[did][dExtposA]);
			cache_get_value_int(i, "intvw", dData[did][dIntvw]);
			cache_get_value_int(i, "intint", dData[did][dIntint]);
			cache_get_value_float(i, "intposx", dData[did][dIntposX]);
			cache_get_value_float(i, "intposy", dData[did][dIntposY]);
			cache_get_value_float(i, "intposz", dData[did][dIntposZ]);
			cache_get_value_float(i, "intposa", dData[did][dIntposA]);
