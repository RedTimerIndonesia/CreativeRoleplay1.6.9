...
public OnGameModeInit()
{
	...
	//Dynamic CP
	ShowRoomCP = CreateDynamicCP(1770.60, -1766.70, 13.83, 1.0, -1, -1, -1, 5.0);
	CreateDynamic3DTextLabel("Buy Vehicle", COLOR_GREEN, 1770.60, -1766.70, 13.83, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1);
	
	ShowRoomCPRent = CreateDynamicCP(1768.66, -1763.34, 13.83, 1.0, -1, -1, -1, 5.0);
	CreateDynamic3DTextLabel("Rental Vehicle", COLOR_LBLUE, 1768.66, -1763.34, 13.83, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1);
...
public OnGameModeExit()
{
	...
	foreach(new pid : Plants)
	{
		...
		printf("[Farmer Plant] Number of Saved: %d", count);
	}
...
public OnPlayerEnterDynamicCP(playerid, checkpointid)
{
	...
	{
		new str[1024];
		format(str, sizeof(str), ""WHITE_E"%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days\n%s\t"LG_E"$500 / 3 days",
...
ptask PlayerUpdate[999](playerid)
{
	...
	foreach(new pid : Plants)
	{
		if(IsPlayerInDynamicCP(playerid, PlantData[pid][PlantCP]) && GetPlayerInterior(playerid) == 0)
		{
